class App extends React.Component {
    ...
    render() {
        console.log("Renederowanie aplikacji");
        return (<div>
...
class Child1 extends React.Component {
    ...
    render() {
        console.log("Renederowanie Child1");
        return (
            <div>{String(this.props.status)}
            </div>
        )
    }
}
...
class Child2 extends React.Component {
    ...
    componentDidUpdate() {
        console.log("Child12 aktualizowana");
    }

    componentWillUnmount() {
        console.log("--------------------");
        console.log("Child12 odmontowany");
